...
@cenum cutensorAlgo_t::Int32 begin
    ...
    CUTENSOR_ALGO_GETT_VAR1 = 0
    CUTENSOR_ALGO_GETT_VAR2 = 1 
    CUTENSOR_ALGO_GETT_VAR3 = 2
    CUTENSOR_ALGO_GETT_VAR4 = 3
    CUTENSOR_ALGO_GETT_VAR5 = 4
    CUTENSOR_ALGO_GETT_VAR6 = 5 
    CUTENSOR_ALGO_GETT_VAR7 = 6
    CUTENSOR_ALGO_GETT_VAR8 = 7
    CUTENSOR_ALGO_GETT_VAR9 = 8
end
